...
public class StickyScrollView extends ScrollView {
    ...
    private OffsetMeasure offsetMeasure = null;

    public void setOffsetMeasure(OffsetMeasure offsetMeasure) {
        this.offsetMeasure = offsetMeasure;
    }

    protected int getTopOffset() {
        return offsetMeasure == null ? 0 : offsetMeasure.getOffset();
    }
    ...
    private void doTheStickyThing() {
        ...
        if(viewThatShouldStick!=null){
            stickyViewTopOffset = approachingView == null ? getTopOffset() : Math.min(getTopOffset(), getTopForViewRelativeOnlyChild(approachingView) - getScrollY()  + (clippingToPadding ? 0 : getPaddingTop()) - viewThatShouldStick.getHeight());
